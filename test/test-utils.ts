...
export const matchFetchParams = (expected: FetchParams): SinonMatcher =>
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: fine in tests
    sinon.match((actual: FetchParams) => {
